...
>((props, ref) => {
  ...
  if (numberOfSlides > 1) {
    return (
      <div ref={ref} className={`flex ${props.className}`}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            key={i}
            className={`mx-1 h-1.5 w-1.5 rounded-full p-0 ${i === currentSlide
              ? 'scale-125 transform bg-primary hover:bg-destructive'
